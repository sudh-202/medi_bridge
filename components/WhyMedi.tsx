    ...
    return (
        ...
        */
        <div>
            ...
            <Image src="/news1.webp" alt='news1' width={1200} height={100} className=' mx-auto my-20'/>
            <Image src="/letter.webp" alt='news1' width={1000} height={100} className=' mx-auto my-20'/>
            </div>
    );
}
